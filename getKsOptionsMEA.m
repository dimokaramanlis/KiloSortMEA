...
ops.Th               = [2   4  4];  % threshold for detecting spikes on template-filtered data, (suggested values were [4 10 10], )
ops.lam              = [10 50 50];   % large means amplitudes are forced around the mean, (suggested values were [5 20 20], [10 30 30])	, ours was [15 50 50]
