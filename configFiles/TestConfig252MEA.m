...
ops.fbinary             = 'E:\Karamanlis_20180712_252MEA10030_mar_fr_le_p1\all_data.dat'; % will be created for 'openEphys' and 'mcd'		
ops.fproc               = 'E:\Karamanlis_20180712_252MEA10030_mar_fr_le_p1\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = 'E:\Karamanlis_20180712_252MEA10030_mar_fr_le_p1'; % 'openEphys' amd 'mcd' only: where raw files are
%==========================================================================
...
ops.nt0                 =25; %spike template time bins
...
ops.Th               = [3 6 6];  % threshold for detecting spikes on template-filtered data
%(suggested values were [4 10 10], too high for low amp spikes, [2 4 4] works best for MEA)
ops.lam              = [15 50 50];   % large means amplitudes are forced around the mean 
%(suggested values were [5 20 20], [10 30 30], [12 40 40])		
...
dd                  = load('PCspikesTest.mat'); % you might want to recompute this from your own data		
