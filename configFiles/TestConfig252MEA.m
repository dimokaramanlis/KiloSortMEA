...
ops.binpathD = strrep(ops.root,ops.root(1:2),'F:/Kilosort');   % added by MHK
...
ops.nt0                 = 21; %spike template time bins
ops.nt0min              = 6;
...
ops.Th               = [3 5 5];  % threshold for detecting spikes on template-filtered data, (suggested values were [4 10 10], )
...
ops.freqMergeSplit   = ceil (1600 * ops.fs/25e3);      % original was 1600
%==========================================================================		
