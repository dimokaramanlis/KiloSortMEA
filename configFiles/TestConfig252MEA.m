...
ops.fbinary             = 'E:\Karamanlis_20180405_252MEA20030_sr_le\all_data.dat'; % will be created for 'openEphys' and 'mcd'		
ops.fproc               = 'E:\Karamanlis_20180405_252MEA20030_sr_le\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = 'E:\Karamanlis_20180405_252MEA20030_sr_le'; % 'openEphys' amd 'mcd' only: where raw files are
%==========================================================================
...
ops.nNeighPC            = 10; % visualization only (Phy): number of channnels to mask the PCs, leave empty to skip (12)		
ops.nNeigh              = 14; % visualization only (Phy): number of neighboring templates to retain projections of (16)		
...
ops.NT                  = 128*0.75*1024+ ops.ntbuff;% this is the batch size (try decreasing if out of memory) 		
